...
if [ -z "$1" ]; then
    echo "Usage: ./compress-image.sh <image_path_or_directory>"
    echo "Example: ./compress-image.sh app/src/main/res/drawable"
    echo "Example: ./compress-image.sh app/src/main/res/drawable/icon.png"
    exit 1
fi
